...
class ECMAScriptLexer extends Lexer {
    /**
    ...
    */
    ...
    constructor(input) {
        ...
        this._interp = new LexerATNSimulator(this, ECMAScriptLexer._ATN, ECMAScriptLexer.DecisionsToDFA, new PredictionContextCache());
    }
    get grammarFileName() { return "ECMAScript.g4"; }
    get literalNames() { return ECMAScriptLexer.literalNames; }
    get symbolicNames() { return ECMAScriptLexer.symbolicNames; }
    get ruleNames() { return ECMAScriptLexer.ruleNames; }
    get serializedATN() { return ECMAScriptLexer._serializedATN; }
    get channelNames() { return ECMAScriptLexer.channelNames; }
    get modeNames() { return ECMAScriptLexer.modeNames; }
    // @Override
    ...
    static get _ATN() {
        if (!ECMAScriptLexer.__ATN) {
            ECMAScriptLexer.__ATN = new ATNDeserializer().deserialize(ECMAScriptLexer._serializedATN);
        }
...
ECMAScriptLexer.EOF = Token.EOF;
ECMAScriptLexer.channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"];
ECMAScriptLexer.literalNames = [null, null,
    null, "'['",
    "']'", "'('",
    "')'", "'{'",
    "'}'", "';'",
    ...
    "'export'",
    "'import'"];
ECMAScriptLexer.symbolicNames = [null, "RegularExpressionLiteral",
    "LineTerminator",
    "OpenBracket",
    "CloseBracket",
    "OpenParen",
    ...
    "SingleLineComment",
    "UnexpectedCharacter"];
ECMAScriptLexer.modeNames = ["DEFAULT_MODE",];
...
ECMAScriptLexer._serializedATN = [4, 0, 103, 926, 6, -1, 2, 0,
...
ECMAScriptLexer.DecisionsToDFA = ECMAScriptLexer._ATN.decisionToState.map((ds, index) => new DFA(ds, index));
