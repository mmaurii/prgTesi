        ...
        try {
            this.enterOuterAlt(localctx, 1);
            {
                ...
                if (!(this.notOpenBraceAndNotFunctionAndNotInterface())) {
                    throw this.createFailedPredicateException("this.notOpenBraceAndNotFunctionAndNotInterface()");
                }
                this.state = 1048;
...
export class ImportModuleItemsContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitImportModuleItems) {
...
export class ImportAliasNameContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitImportAliasName) {
...
export class ModuleExportNameContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitModuleExportName) {
...
export class ImportedBindingContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitImportedBinding) {
...
export class ExportModuleItemsContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitExportModuleItems) {
...
export class ExportAliasNameContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitExportAliasName) {
...
export class ForVarOfStatementContext extends IterationStatementContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitForVarOfStatement) {
            return visitor.visitForVarOfStatement(this);
        }
        else {
            return visitor.visitChildren(this);
        }
...
export class ClassElementNameContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitClassElementName) {
...
export class PrivateIdentifierContext extends ParserRuleContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitPrivateIdentifier) {
...
export class SpreadOperatorContext extends PropertyAssignmentContext {
    ...
    // @Override
    accept(visitor) {
        if (visitor.visitSpreadOperator) {
            return visitor.visitSpreadOperator(this);
        }
        else {
            return visitor.visitChildren(this);
        }
