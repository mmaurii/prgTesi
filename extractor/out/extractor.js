...
class Extractor {
    constructor() {
        ...
        this.annotatedCodeFilePath = "./annotatedCode/input3.ts";
        //flag to stop finding function annotations
        this.endOfAnnotation = true;
    }
    async extract(path = this.annotatedCodeFilePath) {
        let miniSLCode = "\n";
     ...
     */
    getFunctionInvoked(index, fnName) {
     ...
     */
    findFunctionAnnotations(index = 0) {
     ...
     */
    readFunctionAnnotations(i, annotation) {
